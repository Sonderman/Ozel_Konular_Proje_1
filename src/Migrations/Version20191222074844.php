 ...
 */
final class Version20191222074844 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD subject VARCHAR(100) DEFAULT NULL, ADD userid INT DEFAULT NULL, DROP car_id, DROP customer_id, CHANGE comment comment VARCHAR(255) DEFAULT NULL, CHANGE rate rate DOUBLE PRECISION DEFAULT NULL, CHANGE ip ip VARCHAR(30) DEFAULT NULL, CHANGE status status VARCHAR(20) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE messages CHANGE name name VARCHAR(30) DEFAULT NULL, CHANGE email email VARCHAR(100) DEFAULT NULL, CHANGE subject subject VARCHAR(100) DEFAULT NULL, CHANGE message message VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(10) DEFAULT NULL, CHANGE ip ip VARCHAR(20) DEFAULT NULL, CHANGE note note VARCHAR(255) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD car_id INT NOT NULL, ADD customer_id INT NOT NULL, DROP subject, DROP userid, CHANGE comment comment VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE status status VARCHAR(15) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE ip ip VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE created_at created_at DATETIME NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE rate rate DOUBLE PRECISION NOT NULL');
